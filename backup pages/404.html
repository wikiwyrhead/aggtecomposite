      ...
      <div class="container"> 
        ...
        <div class="row"> 
          ...
          <div class="col-md-4 col-sm-6">
            <div class="top-left">
              <p>Welcome to Sunrise construction & repairer</p>
            </div>
          </div>
          <!--col end--> 
  ...
  <section class="inner-heading">
    <div class="container">
      ...
      <ul class="xs-breadcumb">
        <li><a href="index.html"> Home  / </a> <a href="index.html">Pages /</a> Error 404</li>
      </ul>
    </div>
  </section>
  <!--inner-heading end--> 
        ...
        <div class="col-md-12 col-sm-12">
          <div class="error-page">
            ...
            <p>The page you are looking is not available or has been removed.
              Try going to Home Page by using the helpful links.</p>
          </div>
        </div>
      </div>
      <div class="row">
            ...
            <div class="row">
              <div class="col-md-5">
                ...
                <ul>
                  ...
                  <li><a href="#">Shop</a></li>
                  <li><a href="#">Purchase Newslog</a></li>
                </ul>
              </div>
              <div class="col-md-7">
                <h2>Try again</h2>
