    ...
    <div class="copyright-content">
      ...
      <div class="row">
       ...
       <div class="col-md-6 col-sm-6">
           <p><a target="_blank" href="https://www.facebook.com/wpc.claddingdecking">© 2020 Aquaponics GoGreen All Rights Reserved</a> Design by <a href="mailto:jjanzen.go@gmail.com">GoTech Web Solutions</a></p>
          </div>
        <!--col end-->
        <!--col start-->
        <div class="col-md-6 col-sm-6">
                ...
                <div class="warranty-content">
                  <p><br><strong>AGGTE WPC Cladding & Decking Limited Warranty Details</strong><br>
                    ...
                    In the event that the purchaser discovers a defect in the Aquaponics Go Green Trading & Enterprise (T/A AGGTE Composites) Products during the term of warranty, the purchaser must:<br>
                        •	notify  AGG Trading & Enterprise in email, at following <a target="_blank" href="contact.php">email address: sales@aggtecomposites.com</a>. within thirty (30) days but not later than the end of the term upon the discovery of the alleged defect; and<br>
